...
*   **Database Migrations:** A comprehensive MySQL migration tracking system is in place for schema changes, complementing the primary PostgreSQL strategy. Latest migration: `2025-11-10_multi_grn_document_series.sql` adds doc_series_id and doc_series_name columns to multi_grn_batches table with index for improved query performance.
